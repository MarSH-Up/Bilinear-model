...
def semisynthecticDataExtraction(
    ...
    deoxy_file_path = os.path.join(root_directory, "src", "NoiseData", "deoxyhb_1.txt")
    oxy_file_path = os.path.join(root_directory, "src", "NoiseData", "oxyhb_1.txt")
...
def add_noise_to_hemodynamics(
    ...
    deltaQ += whiteNoise_resampled * (whiteNoise_gain / 6)
    deltaH += whiteNoise_resampled * (whiteNoise_gain / 6)
